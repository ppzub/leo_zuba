...
<span class="my-date">{{$post->getDate()}}</span>
	...
	@endif
	<div class="fb-like" data-href="{{route('index')}}/news/{{$post->id}}" data-width="50" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="true" data-colorscheme="light"></div>
	<div class="fb-comments" data-href="{{route('index')}}/news/{{$post->id}}" data-numposts="5"
