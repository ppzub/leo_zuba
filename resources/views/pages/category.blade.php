<div class="row">
	...
	<div class="col xl12 l12 m12 s12">
		...
		@endif
		<div class="fb-like" data-href="{{route('index')}}/{{$cat->alias}}" data-width="50" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="true" data-colorscheme="light"></div>
		<div class="fb-comments" data-href="{{route('index')}}/{{$cat->alias}}" data-numposts="5"
