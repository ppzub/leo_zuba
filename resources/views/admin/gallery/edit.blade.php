	...
	<div class="center-align">
	  <a href="{{route('admin')}}" class="deep-purple lighten-2 white-text waves-effect waves-purple btn-flat">адмінка</a>
        ...
        <div class="row valign-wrapper">
			...
			<h6 class="MyTab">	Редагувати галерею</h6>
		</div>
		@include('admin.errors')
{{ Form::open([
	'route' => ['gallery.update', $post->id],
	'files' => true,
	'method' => 'put'
])}}
			<div class="row">
                <div class="file-field input-field col xl6 l6 m6 s12">
					...
					<div class="file-path-wrapper">
					   	<input class="file-path validate grey-text text-lighten" type="text" value="фотку-другу до галереї">
					</div>
